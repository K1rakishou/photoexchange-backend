        ...
        accept(MediaType.APPLICATION_JSON).nest {
          POST("/update_token", updateFirebaseTokenHandler::handle)
				...
				accept(MediaType.APPLICATION_JSON).nest {
					...
					GET("/receive_photos/{user_id}/{photo_names}", receivePhotosHandler::handle)
					GET("/get_photos_additional_info/{user_id}/{photo_names}", getPhotosAdditionalInfoHandler::handle)
