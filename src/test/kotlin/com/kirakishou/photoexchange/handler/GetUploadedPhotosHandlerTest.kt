...
class GetUploadedPhotosHandlerTest : AbstractHandlerTest() {
	...
	fun `should return uploaded photos with uploader coordinates`() {
		...
		runBlocking {
      photoInfoDao.save(PhotoInfo(1, 9, -1L, "111", "photo1", true, 11.1, 11.1, 1L, "123")).awaitFirst()
      photoInfoDao.save(PhotoInfo(2, 10, -1L, "111", "photo2", true, 11.1, 11.1, 2L, "123")).awaitFirst()
      photoInfoDao.save(PhotoInfo(3, 11, -1L, "111", "photo3", true, 11.1, 11.1, 3L, "123")).awaitFirst()
      photoInfoDao.save(PhotoInfo(4, 12, -1L, "111", "photo4", true, 11.1, 11.1, 4L, "123")).awaitFirst()
      photoInfoDao.save(PhotoInfo(5, 13, -1L, "111", "photo5", true, 11.1, 11.1, 5L, "123")).awaitFirst()
      photoInfoDao.save(PhotoInfo(6, 14, -1L, "111", "photo6", true, 11.1, 11.1, 6L, "123")).awaitFirst()
      photoInfoDao.save(PhotoInfo(7, 15, -1L, "111", "photo7", true, 11.1, 11.1, 7L, "123")).awaitFirst()
      photoInfoDao.save(PhotoInfo(8, 16, -1L, "111", "photo8", true, 11.1, 11.1, 8L, "123")).awaitFirst()

      photoInfoDao.save(PhotoInfo(9, 1, -1L, "222", "photo9", true, 22.2, 22.2, 1L, "123")).awaitFirst()
      photoInfoDao.save(PhotoInfo(10, 2, -1L, "222", "photo10", true, 22.2, 22.2, 2L, "123")).awaitFirst()
      photoInfoDao.save(PhotoInfo(11, 3, -1L, "222", "photo11", true, 22.2, 22.2, 3L, "123")).awaitFirst()
      photoInfoDao.save(PhotoInfo(12, 4, -1L, "222", "photo12", true, 22.2, 22.2, 4L, "123")).awaitFirst()
      photoInfoDao.save(PhotoInfo(13, 5, -1L, "222", "photo13", true, 22.2, 22.2, 5L, "123")).awaitFirst()
      photoInfoDao.save(PhotoInfo(14, 6, -1L, "222", "photo14", true, 22.2, 22.2, 6L, "123")).awaitFirst()
      photoInfoDao.save(PhotoInfo(15, 7, -1L, "222", "photo15", true, 22.2, 22.2, 7L, "123")).awaitFirst()
      photoInfoDao.save(PhotoInfo(16, 8, -1L, "222", "photo16", true, 22.2, 22.2, 8L, "123")).awaitFirst()
		}
